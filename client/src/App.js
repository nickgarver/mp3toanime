  ...
  <div className="App min-h-screen text-blue-200 d-flex align-items-center justify-content-center">
    ...
    <footer>
      ...
      <div className="footer-socials">
        <a aria-label="Report Bug" data-tooltip="Report Bug" href="https://github.com/nickgarver/mp3toanime/issues" target="_blank" rel="noopener noreferrer" ><FontAwesomeIcon className="socials-icn" icon={faBug} /></a>
